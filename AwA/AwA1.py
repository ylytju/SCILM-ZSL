...
def parse_args():
    ...
    parser.add_argument('--data_dir',type=str, default='../data/AwA1',help='the data directory')
    ...
    parser.add_argument('--lambda_p', type=float32, default=0.4, help='the parameter one')
    parser.add_argument('--lambda_q', type=float32, default=2e-4, help='the balance parameter, default: 2e-4')
